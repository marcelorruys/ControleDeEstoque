...
public class Fornecedor
{
    ...
    [StringLength(15, MinimumLength = 11, ErrorMessage = "O {0} deve ter no mínimo {2} caracteres")]
    ...
    [Display(Name = "CEP")]
    [StringLength(10, MinimumLength = 8, ErrorMessage = "O {0} deve ter no mínimo {2} caracteres")]
    [DataType(DataType.PostalCode)]
    public string Cep { get; set; }

    [Required(ErrorMessage = "Informe o Estado")]
    [StringLength(10, ErrorMessage = "O Estado deve ter no máximo {1} caracteres")]
